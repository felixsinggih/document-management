...
@section('content')
    <div class="card mb-4">
        <div class="card-body">
            <form action="/client/document/update/{{ $document->id }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text"
                            ...
                            placeholder="YYYY-MM-DD" name="due_date" value="{{ old('due_date', $document->due_date) }}"
                            readonly="readonly">
                        @error('due_date')
                            <div class="invalid-feedback">
                                {{ $message }}
